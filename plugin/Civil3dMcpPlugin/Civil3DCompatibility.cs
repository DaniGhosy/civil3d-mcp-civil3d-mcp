...
///
/// Ported from Civil3D-mcp-main (same namespace/CivilExecution/PluginRuntime
/// contract as this repo, so it drops in without adaptation). Shared by any
/// ported *Commands.cs that accesses Civil 3D API surfaces reflectively
/// (tolerant of version differences), alongside this repo's own typed
/// CivilObjectLookup for domains that don't need it.
/// </summary>
