...
/// <summary>
/// Ported from Civil3D-mcp-main. Note: RunoffPipeWorkflowAsync (runoffPipeWorkflow)
/// is intentionally NOT ported yet — it calls PipeHydraulicsCommands, which lands
/// in a later batch. Add it here once PipeHydraulicsCommands.cs exists.
/// </summary>
    ...
    return Task.FromResult<object?>(new Dictionary<string, object?>
    {
      ...
      ["operations"] = new List<Dictionary<string, object?>>()
      {
        ...
        new()
        {
          ...
          ["status"] = "planned",
          ["description"] = "Runs a combined runoff-to-pipe-network workflow including HGL and hydraulic capacity analysis. Pending PipeHydraulicsCommands.",
        },
      },
