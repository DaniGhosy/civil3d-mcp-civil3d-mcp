...
/// <summary>
/// Ported from Civil3D-mcp-main. Reflection-friendly counterpart to this
/// repo's own <see cref="CivilObjectLookup"/> (typed FindByName/FindEntityByName) —
/// used by ported *Commands.cs files that were written against this richer,
/// reflection-based surface (GetPropertyValue/InvokeMethod via
/// Civil3DCompatibility) instead of direct typed member access.
/// </summary>
