...
/// <summary>
/// Ported from Civil3D-mcp-main. Resolves layer/site/style/label-set/band-set
/// ObjectIds by name, falling back to a sensible default (current layer, first
/// style in the collection) when no name is supplied.
/// </summary>
